...
def main():
    ...
    subset_insta_ramen = tune_insta_ramen(X, Y, T, obs_features, args.n_env, use_xgboost=True, logger=logger)
    error_insta_ramen = evaluate_subset(subset_insta_ramen, data, use_xgboost=True)
